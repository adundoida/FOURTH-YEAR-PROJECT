						...
						<table class="table table-condensed table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="">Name</th>
									<th class="">Hostel Owned</th>
									<th class="">Rent per Semester</th>
									<th class="">Distance from Jooust</th>
							...
							<tbody>
								<?php 
								$i = 1;
								$landlord = $conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.house_no,h.price FROM tenants t inner join houses h on h.id = t.house_id where t.status = 1 order by h.house_no desc ");
