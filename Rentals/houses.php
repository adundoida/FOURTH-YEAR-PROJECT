			...
			<form action="" id="manage-house">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Price per Semester</label>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Hostel Name: <b><?php echo $row['house_no'] ?></b></p>
										<p><small>Hostel Location: <b><?php echo $row['cname'] ?></b></small></p>
									...
									<td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-primary book_house" type="button" data-id="<?php echo $row['id'] ?>">Book</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					$('#msg').html('<div class="alert alert-danger">Hostel details already exist.</div>')
					end_load()
				}
			}
		})
